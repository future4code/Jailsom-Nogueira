...
// const todasConsultas = consultas.filter((aConsulta, i, a) => {
//     if (aConsulta.genero === "masculino") {
//         aConsulta.genero = "Sr."
//         aConsulta.lembrar = "lembrá-lo"
//     } else {
//         aConsulta.genero = "Sra."
//         aConsulta.lembrar = "lembrá-la"
//     }

//     if (aConsulta.cancelada === false) {
//         aConsulta.email = "Olá, " + aConsulta.genero + aConsulta.nome + ".Estamos enviando esta mensagem para " + aConsulta.lembrar + " da sua consulta no dia " + aConsulta.dataDaConsulta + ".Por favor, acuse o recebimento deste e-mail."
//     } else {
//         aConsulta.email = "Olá, " + aConsulta.genero + aConsulta.nome + ".Infelizmente, sua consulta marcada para o dia " + aConsulta.dataDaConsulta + " foi cancelada. Se quiser, pode entrar em contato conosco para remarcá-la"
//     }
//     return aConsulta
// })
...
// contas.forEach((pessoa, i, a) => {
//     let totalCompras = 0
//     let j = 0
//     for (j = 0; j < pessoa.compras.length; j++) {
//         totalCompras += pessoa.compras[j];
//     }
//     pessoa.saldoTotal = pessoa.saldoTotal - totalCompras
// })
// console.log(contas)